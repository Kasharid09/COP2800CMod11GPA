...
public class Bird implements Comparable<Bird> {
    ...
    public Bird(int sampleNum, double culmenLength, 
                double culmenDepth, double bodyMass, String sex) throws 
            InvalidBirdDataException {
        
        if (sampleNum < 0 || culmenLength < 0 || bodyMass < 0
                || sex == null || sex.isEmpty()){
            throw new InvalidBirdDataException("Invalid Bird data encountered");
        }
